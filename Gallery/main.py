...
def welcomeScreen():
    ...
    messagey = int((SCREENHEIGHT*0.13)/2)
    basex = 0
...
def mainGame():
    ...
    while True:
        ...
        for pipe in upperPipes:
            pipeMidPos = pipe['x'] + GAME_SPRITES['pipe'][0].getwidth()/2
...
if __name__ == "__main__":
    ...
    pygame.display.set_caption('Flappy Bird By Learner')
